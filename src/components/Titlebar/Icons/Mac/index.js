...
const Icon = ({ children, onHover, ...props }) => {

  return (
    <svg
      {...props}
      style={onHover ? { ...iconStyles, ...hoverStyles } : iconStyles}
    >
      {children}
    </svg>
  );
...
const MacClose = ({onHover}) => {
  ...
  return (
    <div style={{ position: "relative", width: 12, height: 12 }}>
      ...
      <Icon onHover={onHover} {...noOpacity}>
        <path
          opacity="0.5"
...
export { MacClose, MacMinimize, MacMaximize };
